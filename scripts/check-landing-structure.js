...
requireText("Android 1.8.4 release state", landing, /Google Play Store \(v1\.8\.4\)/);
...
requireText("iOS 1.8.4 release state", landing, /Apple App Store \(v1\.8\.4\)/);
requireText("pinned Android 1.8.4 release", app, /tag_name: 'v1\.8\.4'/);
requireText("pinned iOS 1.8.4 release", app, /'track-me-ios': \[[\s\S]*tag_name: 'v1\.8\.4'/);
